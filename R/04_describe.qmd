...
# Constructing custom labels
cancer_labels <- list(
  "ALL" = "Acute lymphoid leukemia (ALL)",
  "AML" = "Acute myeloid leukemia (AML)")

# Labeller function to pass to `facet_wrap`
# TODO: change labeller so it is not deprecated
cancer_labeller <- function(variable, value) {
  return(cancer_labels[value])
}
...
mean_expression_hist +
  ...
  labs(
    title = "Zooming in on means around median",
    x = "Mean gene expression (a.u.)",
    y = "Count"
  ) +
  theme_minimal() +
...
# TODO: remove from here and import from `99_proj_func.qmd` only
