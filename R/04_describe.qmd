...
ggsave(filename = "04_mean_expression_hist_general.png", plot = mean_expression_hist_general, device = "png", path = "../results")
```
...
ggsave(filename = "04_mean_expression_hist_zoom.png", plot = mean_expression_hist_zoom, device = "png", path = "../results")
```
